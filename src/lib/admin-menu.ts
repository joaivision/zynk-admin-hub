...
export const adminMenu: AdminGroup[] = [
  { title: "Dashboard", icon: LayoutDashboard, slug: "" },
  {
    ...
    items: [
      ...
      { title: "Partner Apps (OAuth)", slug: "settings/partner-apps" },
      { title: "Public API & Rate Limits", slug: "settings/api-rate-limits" },
      { title: "Webhooks Registry", slug: "settings/webhooks" },
      { title: "Domains & DNS", slug: "settings/domains" },
      { title: "SEO & Metadata", slug: "settings/seo" },
      { title: "Sitemap & robots.txt", slug: "settings/sitemap" },
      { title: "Cookie & Consent Banner", slug: "settings/consent" },
      { title: "Storage & Media (CDN)", slug: "settings/storage" },
      { title: "Search Engine Config", slug: "settings/search" },
      { title: "Cache & Edge Rules", slug: "settings/cache" },
      { title: "Localization Strings", slug: "settings/i18n-strings" },
      { title: "Backup & Data Retention", slug: "settings/backups" },
      { title: "Audit Log Settings", slug: "settings/audit-config" },
      { title: "Maintenance Mode", slug: "settings/maintenance" },
      { title: "Secrets & Env Vars", slug: "settings/secrets" },
      { title: "Abuse & Rate-limit Rules", slug: "settings/abuse-rules" },
    ],
  },
  {
